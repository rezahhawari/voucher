...
<head>
    ...
    <title>Flatter Media Access Point</title>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="dashboard.html">
                        ...
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                            <img src="{{asset('logo2.png')}}" alt="homepage" width="190px"/>
                        </b>
                        <!--End Logo icon -->
                    ...
                    <ul id="sidebarnav">
                        ...
                        @can('admin')
                            {{-- <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.event')}}"
                                    aria-expanded="false">
                            ...
                            {{-- <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.kos')}}"
                                    aria-expanded="false">
                                    <i class="fa fa-table" aria-hidden="true"></i>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.venue')}}"
                                    aria-expanded="false">
                                    <i class="fa fa-table" aria-hidden="true"></i>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.duration')}}"
                                    aria-expanded="false">
                                    <i class="fa fa-table" aria-hidden="true"></i>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.voucher')}}"
                                    aria-expanded="false">
                                    <i class="fa fa-table" aria-hidden="true"></i>
                        ...
                        @endcan
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.transaction')}}"
                                aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
                        ...
                        <li class="text-center p-20 upgrade-btn">
                            <form action="/logout" method="post">
                                @csrf
                                <button type="submit" class="btn btn-danger text-white w-100">Sign Out</button>
                            </form>
                        </li>
                    </ul>
