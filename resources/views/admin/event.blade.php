...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h1 class="box-title">Events</h1>
                    <a data-bs-target="#addevent" data-bs-toggle="modal" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Event</a>
...
@section('script')
    ...
    <script>
        ...
        function submit() {
            ...
            var sdate = $('#inputsdate').val();
            var edate = $('#inputedate').val();
