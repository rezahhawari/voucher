...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-12">
                <div class="white-box analytics-info">
                    ...
                    <ul class="list-inline two-part d-flex align-items-center mb-0">
                        ...
                        <li class="ms-auto"><span class="counter text-success">{{$counttoday}}</span></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-12">
                <div class="white-box analytics-info">
                    <h3 class="box-title">Total Transaction</h3>
                    <ul class="list-inline two-part d-flex align-items-center mb-0">
                        <li>
                        ...
                        <li class="ms-auto"><span class="counter text-purple">{{$totaltrans}}</span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="white-box analytics-info">
                    <h3 class="box-title">Estimated Income Today</h3>
                    <ul class="list-inline two-part d-flex align-items-center mb-0">
                        <li>
                        ...
                        <li class="ms-auto"><span class="counter text-info">{{$estimateincometoday}}</span>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table no-wrap" id="table">
                            ...
                            <tbody>
                                ...
                                @foreach ($today as $t)
                                @can('venue')
                                    @if ($t->venue->user_id == Auth::user()->id)
                                        <tr>
                                            <td>{{$i++}}</td>
                                            <td>{{$t->created_at}}</td>
                                            <td>{{$t->venue->name}}</td>
